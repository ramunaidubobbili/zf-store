...
const Header = ({match, cartCount, logout}) => {
    return (
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="collapse navbar-collapse justify-content-end" id="navbarTogglerDemo03">
                            ...
                            <ul className="nav col-12 col-lg-auto my-2 justify-content-center align-items-center my-md-0 text-small">
                                <li>
                                    <Link to={`${match.path}/profile`} className="nav-link text-secondary text-center px-2 py-0">
                                        <i className="fa fa-user d-block mx-auto"></i>
                                        <small>Profile</small>
                                    </Link>
                                </li>
                                <li>
                                    <Link to={`${match.path}/wishlist`}className="nav-link text-secondary text-center px-2 py-0">
                                        <i className="fa fa-heart d-block mx-auto"></i>
                                        <small>Wishlist</small>
                                    </Link>
                                </li>
                                <li>
                                    <Link to={`${match.path}/cart`} className="nav-link position-relative text-secondary text-center px-2 py-0">
                                        <i className="fa fa-shopping-bag d-block mx-auto"></i>
                                        <small>Bag 
                                            {cartCount !== 0 && <span className="cartCount position-absolute fw-bold">{ cartCount}</span>}
                                        </small>
                                    </Link>
                                    
                                </li>
                                <li>
                                    <button className="btn btn-primary ms-2" onClick={logout}>Logout</button>
                                </li>
                            </ul>
                        </div>
                    </div>
